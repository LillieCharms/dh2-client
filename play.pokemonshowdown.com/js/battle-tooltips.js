...
var _pokemon=this.battle.nearSide.active[
...
buf=this.showMoveTooltip(move,type,_pokemon,serverPokemon,gmaxMove);
break;
}
...
var _pokemon3=_side.active[activeIndex];
...
buf=this.showPokemonTooltip(_pokemon3,_serverPokemon,true);
break;
}
case'switchpokemon':{
...
buf=this.showPokemonTooltip(_pokemon5,_serverPokemon3);
break;
}
case'field':{
...
if(this.battle.tier.includes("VaporeMons")){
if(clientPokemon.volatiles['protomosis'+_statName2]||clientPokemon.volatiles['photondrive'+_statName2]||
clientPokemon.volatiles['protocrysalis'+_statName2]||clientPokemon.volatiles['neurondrive'+_statName2]||
clientPokemon.volatiles['protostasis'+_statName2]||clientPokemon.volatiles['runedrive'+_statName2]){
if(_statName2==='spe'){
speedModifiers.push(1.5);
}else{
stats[_statName2]=Math.floor(stats[_statName2]*1.3);
