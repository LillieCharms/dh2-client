...
var placeholderSprite=spriteData.isFrontSprite?
...
typeAnim=function typeAnim(pokemon,types){var _this4=this;
var result=BattleLog.escapeHTML(types).split('/').map(function(type){return(
Dex.getTypeIcon(type,null,_this4.battle.mod));}
).join(' ');
...
updateSpritesForSide=function updateSpritesForSide(side){var _side$missedPokemon2;
(_side$missedPokemon2=side.missedPokemon)==null||(_side$missedPokemon2=_side$missedPokemon2.sprite)==null||_side$missedPokemon2.destroy();
...
status+=Dex.getTypeIcon(_type,null,this.scene.battle.mod);
}
