...
getSpriteMod=function getSpriteMod(optionsMod,spriteId,filepath){var overrideStandard=arguments.length>3&&arguments[3]!==undefined?arguments[3]:false;
if(!window.ModSprites[spriteId])return'';
if((!optionsMod||!window.ModSprites[spriteId][optionsMod])&&!overrideStandard){
for(var modName in window.ModSprites[spriteId]){
...
{var _window$Config2,_spriteData;var options=arguments.length>2&&arguments[2]!==undefined?arguments[2]:{gen:6,mod:''};
...
var modSpriteId=toID(modSpecies.spriteid);
...
if(!((_spriteData=spriteData).cryurl&&(_spriteData.cryurl='https://'+Config.routes.psmain+'/'+spriteData.cryurl))){var _window$ModSprites$mo;


if((_window$ModSprites$mo=window.ModSprites[modSpriteId])!=null&&(_window$ModSprites$mo=_window$ModSprites$mo[options.mod])!=null&&_window$ModSprites$mo.includes('cries')){
...
var allowAnim=(!hasCustomSprite||hasCustomSprite&&hasCustomAnim)&&!Dex.prefs('noanim')&&!Dex.prefs('nogif');
...
if(window.ModSprites[modSpriteId]&&window.ModSprites[modSpriteId+'f']){
name+='f';
}
}
...
getTeambuilderSpriteData=function getTeambuilderSpriteData(pokemon){var _window$Config3;var gen=arguments.length>1&&arguments[1]!==undefined?arguments[1]:0;var mod=arguments.length>2&&arguments[2]!==undefined?arguments[2]:'';
...
var genTable=window.BattleTeambuilderTable["gen"+i];
if(genTable.overrideItemInfo[id]){
Object.assign(data,table.overrideItemInfo[id]);
}
}
if(_this2.modid!=="gen"+_this2.gen&&table.overrideItemInfo[id]){
Object.assign(data,table.overrideItemInfo[id]);
}
...
if(this.pokeballs)return this.pokeballs;
this.pokeballs=[];
if(!window.BattleItems)window.BattleItems={};for(var _i12=0,_Object$values4=
Object.values(window.BattleItems);_i12<_Object$values4.length;_i12++){var data=_Object$values4[_i12];
...
var text='';for(var _i14=0,_team2=
team;_i14<_team2.length;_i14++){var curSet=_team2[_i14];
...
if(curSet.ivs){
var defaultIvs=true;
var hpType='';for(var _i16=0,_curSet$moves2=
curSet.moves;_i16<_curSet$moves2.length;_i16++){var move=_curSet$moves2[_i16];
...
if(curSet.moves){for(var _i18=0,_curSet$moves4=
curSet.moves;_i18<_curSet$moves4.length;_i18++){var _move=_curSet$moves4[_i18];
...
var _template48=this.template('changeAbility',_id11);
...
var _template49=this.template('activate',_id11);
...
_template63=this.template(_templateId10,_id15);
return _line25+_template63.replace('[POKEMON]',this.pokemon(_pokemon31));
}
...
var _template67=this.template(_templateId12,_id16);
...
var _template68=this.template(_templateId13,_id17);
